...
public class EdenParser extends Parser {
	...
	public static final int
		...
		RULE_while_stmt = 9, RULE_func_call = 10, RULE_param_list = 11, RULE_expr = 12, 
		RULE_add_expr = 13, RULE_mul_expr = 14, RULE_add_op = 15, RULE_mul_op = 16, 
		RULE_term = 17;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "block", "decl", "var_decl", "impl_var_decl", "stmt", "assign_stmt", 
			"func_call_stmt", "if_stmt", "while_stmt", "func_call", "param_list", 
			"expr", "add_expr", "mul_expr", "add_op", "mul_op", "term"
		};
	}
